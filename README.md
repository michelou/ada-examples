...
Tool versions:
   ...
   Gwindows 13-Apr-2024, make 4.4.1, code 1.104.3,
   git 2.51.0, diff 3.11, bash 5.2.37(1)
...
<a href="https://git-scm.com/download/win">PortableGit-2.51.0-64-bit.7z.exe</a>                    <i>( 46 MB)</i>
...
[git_relnotes]: https://github.com/git/git/blob/v2.51.0/Documentation/RelNotes/2.51.0.txt
