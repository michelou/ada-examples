...
set __GNATMAKE_INCLS=-I"%GNAT_HOME%\include\aunit" -I"%_LIB_DIR%" -I"%_SOURCE_MAIN_DIR%"
set __GNATMAKE_OPTS=-gnat2022 -we %__GNATMAKE_INCLS% -D "%_TARGET_OBJ_DIR%" -o "%_EXE_FILE%"
