...
set _MAIN_NAME=rot13
set _MAIN_ARGS="%_TARGET_DIR%\input.txt" "%_TARGET_DIR%\output.txt"
...
echo Program that does ROT13 transformation on a text file. 1>"%_TARGET_DIR%\input.txt"
goto :eof
